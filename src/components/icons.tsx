...
export function GitHubIcon({ size = 15, style }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} style={{ fill: 'currentColor', ...style }}>
      <path d="M12 .5C5.37.5 0 5.87 0 12.5c0 5.3 3.44 9.8 8.21 11.39.6.11.82-.26.82-.58 0-.29-.01-1.05-.02-2.06-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.73.08-.73 1.2.08 1.84 1.24 1.84 1.24 1.07 1.83 2.81 1.3 3.5.99.11-.78.42-1.3.76-1.6-2.67-.3-5.47-1.34-5.47-5.95 0-1.31.47-2.39 1.24-3.23-.12-.3-.54-1.52.12-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 0 1 3-.4c1.02 0 2.05.14 3 .4 2.29-1.55 3.3-1.23 3.3-1.23.66 1.66.24 2.88.12 3.18.77.84 1.24 1.92 1.24 3.23 0 4.62-2.81 5.64-5.49 5.94.43.37.81 1.1.81 2.22 0 1.6-.01 2.9-.01 3.29 0 .32.22.7.83.58A12.01 12.01 0 0 0 24 12.5C24 5.87 18.63.5 12 .5z" />
    </svg>
  );
}
...
export function FacebookIcon({ size = 15, style }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} style={{ fill: 'currentColor', ...style }}>
...
export function PhoneIcon({ size = 14, style }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} style={{ fill: 'currentColor', ...style }}>
