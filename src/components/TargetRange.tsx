    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          position: 'fixed',
          top: mobile ? 'auto' : 86,
          bottom: mobile ? 14 : 'auto',
          insetInlineEnd: mobile ? 10 : 18,
          zIndex: 46,
          pointerEvents: 'none',
          display: 'flex',
          ...
          gap: mobile ? 10 : 6,
          padding: mobile ? '6px 8px 6px 11px' : '11px 14px',
          ...
          <>
            <span
              style={{
                ...
                height: 7,
                borderRadius: '50%',
                background: paused ? '#5A6477' : '#FF3D81',
                boxShadow: paused ? 'none' : '0 0 8px #FF3D81',
                flexShrink: 0,
              }}
            />
      ...
      {targets.map((t) => (
        <div
          ...
          style={{
            ...
            marginTop: -t.size / 2,
            zIndex: 45,
            pointerEvents: t.hit ? 'none' : 'auto',
            cursor: 'none',
            touchAction: 'none',
            WebkitTapHighlightColor: 'transparent',
            animation: t.hit
              ? 'targethit .24s ease-out forwards'
              : 'targetpop .28s cubic-bezier(.2,1.5,.4,1) both',
          }}
        >
          {/* outer ring */}
          <span
            style={{
              ...
              boxShadow: `0 0 14px ${t.color}66, inset 0 0 9px ${t.color}44`,
            }}
          />
...
function Row({
  ...
  return (
    ...
    >
      <span
        style={{ fontFamily: mono, fontSize: compact ? 9 : 10.5, letterSpacing: '.1em', color: '#5A6477' }}
      >
        {label}
      </span>
      <span
        style={{
          fontFamily: mono,
          fontSize: big ? (compact ? 16 : 19) : compact ? 12 : 13,
          fontWeight: 700,
          lineHeight: 1,
          color,
        }}
