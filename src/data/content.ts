...
export const PROFILE = {
  ...
  /** Same number, dialable — used for the tel: links. */
  tel: 'tel:+213542866839',
  github: 'mi2odev',
    ...
    work: {
      ...
      items: [
        ...
        },
        {
          ...
          period: '2024',
          bullets: [
            'Application web de réservation d’hôtel : gestion des chambres, des disponibilités et des réservations.',
          ],
  ...
  ar: {
    ...
    skills: {
      ...
      cats: {
        fe: 'الواجهة الأمامية',
        be: 'الواجهة الخلفية',
        data: 'البيانات والذكاء',
        ops: 'DevOps والأدوات',
        cloud: 'الحوسبة السحابية و IoT',
      },
    },
    work: {
      label: 'الخبرة',
      ...
      items: [
        ...
        },
        {
          ...
          period: '2025',
          bullets: [
            'تصميم وتنفيذ مساعد أسئلة وأجوبة متعدد اللغات لمقررات الجامعة، مبني على PyTorch والتعلّم العميق.',
          ],
          tags: ['PyTorch', 'Deep Learning', 'NLP', 'Q&A', 'Multilingual'],
        },
        {
